...
const GridSection = () => {
  return (
    <div className="relative">
      <section className="bg-grid-pattern dark:bg-grid-pattern-dark flex h-[42vh] w-full flex-col items-center space-y-2 py-12 text-center md:py-24 lg:py-32 xl:py-48">
